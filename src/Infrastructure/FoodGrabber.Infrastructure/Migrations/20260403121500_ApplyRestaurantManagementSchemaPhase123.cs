...
{
    public partial class ApplyRestaurantManagementSchemaPhase123 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "MenuCategoryProducts");
            migrationBuilder.DropTable(name: "OrderItemModifiers");
            migrationBuilder.DropTable(name: "OrderStatusHistory");
            migrationBuilder.DropTable(name: "ProductAvailabilityWindows");
            migrationBuilder.DropTable(name: "ProductModifierOptions");
            migrationBuilder.DropTable(name: "ProductPriceHistories");
            migrationBuilder.DropTable(name: "MenuCategories");
            migrationBuilder.DropTable(name: "ProductModifierGroups");
            ...
            migrationBuilder.DropIndex(name: "IX_Menus_branch_id_name", table: "Menus");
            migrationBuilder.DropIndex(name: "IX_Orders_branch_id_created_at", table: "Orders");
            migrationBuilder.DropIndex(name: "IX_Orders_created_at", table: "Orders");
            migrationBuilder.DropIndex(name: "IX_Orders_dining_table_id", table: "Orders");
            migrationBuilder.DropIndex(name: "IX_Orders_status_created_at", table: "Orders");
            migrationBuilder.DropIndex(name: "IX_Products_category_id_is_active", table: "Products");

            migrationBuilder.DropColumn(name: "branch_id", table: "Menus");
            migrationBuilder.DropColumn(name: "branch_id", table: "Orders");
            migrationBuilder.DropColumn(name: "dining_table_id", table: "Orders");
            migrationBuilder.DropColumn(name: "service_type", table: "Orders");
            migrationBuilder.DropColumn(name: "subtotal_amount", table: "Orders");
            migrationBuilder.DropColumn(name: "tax_amount", table: "Orders");
            migrationBuilder.DropColumn(name: "discount_amount", table: "Orders");
            migrationBuilder.DropColumn(name: "item_name_snapshot", table: "OrderDetails");
            migrationBuilder.DropColumn(name: "price_source", table: "OrderDetails");
            migrationBuilder.DropColumn(name: "category_id", table: "Products");
        }
    }
}
