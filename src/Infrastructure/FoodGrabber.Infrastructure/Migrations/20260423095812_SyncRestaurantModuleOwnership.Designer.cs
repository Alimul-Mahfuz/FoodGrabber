...
namespace FoodGrabber.Infrastructure.Migrations
{
    ...
    [Migration("20260423095812_SyncRestaurantModuleOwnership")]
    partial class SyncRestaurantModuleOwnership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodGrabber.Restaurant.Entities.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodGrabber.Restaurant.Entities.DiningTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodGrabber.Restaurant.Entities.Restaurant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodGrabber.Order.Entities.Order", b =>
                {
                    b.HasOne("FoodGrabber.Restaurant.Entities.Branch", "Branch")
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("FoodGrabber.Restaurant.Entities.DiningTable", "DiningTable")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodGrabber.Restaurant.Entities.Branch", b =>
                {
                    b.HasOne("FoodGrabber.Restaurant.Entities.Restaurant", "Restaurant")
                        .WithMany("Branches")
