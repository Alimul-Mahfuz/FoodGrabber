...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await productService.addProduct({ ...formData, tags: finalTags });
  ...
  return (
    <div className="animate-fade-up">
      <div style={{ marginBottom: '2rem' }}>
        ...
        <h1 className="hero-title" style={{ fontSize: '2.5rem' }}>Create Product.</h1>
      </div>
      ...
      <div className="card" style={{ padding: '3rem', maxWidth: '800px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '2rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1.5rem', background: '#F9FAFB', borderRadius: '12px' }}>
             ...
             <span style={{ fontSize: '0.9rem', fontWeight: 600 }}>Active - Show in Menu</span>
          </div>
